                            ...
                            <div class="container">
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-4">
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        <input type="text" id="myInput" class="form-control pl-5" placeholder="Cari nama bidang studi..." onkeyup="myFunction()">
                                        <i class="fas fa-search"></i>
                                    </div>
                                
                                    <!-- Add button with icon -->
                                    <a href="{{route('form.studyform')}}" class="btn btn-primary d-flex text-align-center gap-2">
                                        <i class="fas fa-plus"></i>
                                        <span>Tambahkan Data</span>
                                    </a>
                                </div>
                                
                                <table id="tableStudy" class="table table-striped table-bordered">
...
<script>
    ...
    function myFunction() {
        ...
        table = document.getElementById("tableStudy");
