                        ...
                        <div class="card-body">
                            <div class="container">
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-4">
                                    ...
                                    <a href="{{route('form.contact')}}" class="btn btn-primary d-flex text-align-center gap-2">
                                ...
                                <table id="tableContact" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        @foreach ($posts as $index => $contact)
                                            <tr>
                                                <td>{{ $index + 1 }}</td>
                                                <td>
                                                    {{$contact->location}}
                                                ...
                                                <td>{{ \Carbon\Carbon::parse($contact->created_at)->format('F j, Y') }}
                                                </td>
