                        ...
                        <div class="card-body">
                            <div class="container">
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-4">
                                    ...
                                    <a href="{{route('form.serviceform')}}" class="btn btn-primary d-flex text-align-center gap-2">
                                ...
                                <table id="tableService" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        @foreach ($posts as $index => $service)
                                            <tr>
                                                <td>{{ $index + 1 }}</td>
                                                <td>
                                                    @if ($service->image)
                                                        <img src="{{ asset('storage/'.$service->image) }}" alt="Image" width="50">
                                                    @else
                                                ...
                                                <td>{{ \Carbon\Carbon::parse($service->created_at)->format('F j, Y') }}
                                                </td>
                                                <td class="align-middle text-center">
                                                  <div class="d-inline-flex gap-1">
                                                      ...
                                                      <form action="{{ route('servicepost.destroy', $service->id) }}"
                                                          method="POST"
