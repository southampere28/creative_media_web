            ...
            <div class="row d-flex justify-content-center">
                ...
                <div class="card">
                    <div class="card-header text-center">
                        <h2>{{ isset($edit->id) ? 'Edit Anggota/Staff' : 'Tambahkan Anggota/Staff' }}</h2>
                    </div>
                    <div class="card">
                        <div class="card-body">
                            <div class="container">
                                <form
                                    action="{{ isset($edit->id) ? route('team.update', $edit->id) : route('team.store') }}"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group mb-3">
                                            <label for="imageInput" class="form-label">Tambahkan Foto Profile</label>
                                        ...
                                        <div class="form-group mb-3">
                                            <label for="validationCustom02" class="form-label">Nama Panjang Staff</label>
                                        ...
                                        <div class="form-group mb-3">
                                            <label for="validationCustom03" class="form-label">Bagian / Role</label>
                                            <input type="text" class="form-control" id="validationCustom03"
                                                name="role" placeholder="Website & Mobile Developer"
                                                value="{{ isset($edit->id) ? $edit->role : '' }}" required>
                                            <div class="valid-feedback">
                                                Looks good!
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <textarea class="form-control" id="validationCustom04"
                                                name="description" placeholder="Menyelesaikan studi S1 jurusan Teknik Informatika di Politeknik Negeri Jember."
            ...
            <div class="container">
                ...
                <div class="row mb-3 justify-content-center">
                    <div class="col-md-9 text-center">
                        ...
                        <a href="{{ route('adminview.team') }}"><button class="btn btn-primary text-center">Lihat
                                Postingan</button></a>
                    </div>
                </div>
            </div>
