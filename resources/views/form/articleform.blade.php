...
<head>
    ...
    <title>Add or Modify Article</title>
            ...
            <div class="row d-flex justify-content-center">
                ...
                <div class="card">
                    <div class="card-header text-center">
                        <h2>{{ isset($edit->id) ? 'Edit Artikel' : 'Tambahkan Artikel Baru' }}</h2>
                    </div>
                    <div class="card">
                        <div class="card-body">
                            <div class="container">
                                <form
                                    action="{{ isset($edit->id) ? route('article.update', $edit->id) : route('article.store') }}"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group mb-3">
                                            <label for="validationCustom02" class="form-label">Judul Artikel</label>
                                            <input type="text" class="form-control" id="validationCustom02"
                                                name="title" placeholder="Cara Membuat Konten Viral dan Menarik"
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <textarea class="form-control" id="validationCustom03"
                                                name="description" placeholder="Pernahkah anda melihat konten yang viral di ig, tiktok, atau fb. Dalam artikel ini kami akan membahas mengenai bagaimana cara membuat konten yang viral"
                                                rows="5"
