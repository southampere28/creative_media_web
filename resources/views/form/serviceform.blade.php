            ...
            <div class="row d-flex justify-content-center">
                ...
                <div class="card">
                    <div class="card-header text-center">
                        <h2>{{ isset($edit->id) ? 'Edit Service (Layanan Jasa)' : 'Tambahkan Service (Layanan Jasa)' }}</h2>
                    </div>
                    <div class="card">
                        <div class="card-body">
                            <div class="container">
                                <form
                                    action="{{ isset($edit->id) ? route('servicepost.update', $edit->id) : route('servicepost.store') }}"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label for="validationCustom01" class="form-label">Layanan Jasa</label>
                                            <select class="form-select" id="validationCustom01" name="studyname"
                                                ...
                                                required>
                                                <option selected disabled value="">Pilih Layanan Jasa</option>
                                                <option value="Course & Trainings"
                                                    {{ isset($edit->name) && $edit->name == 'Course & Trainings' ? 'selected' : '' }}>
                                                    Course & Trainings</option>
                                                <option value="Branding & Design"
                                                    {{ isset($edit->name) && $edit->name == 'Branding & Design' ? 'selected' : '' }}>
                                                    Branding & Design</option>
                                                <option value="Web Development"
                                                    {{ isset($edit->name) && $edit->name == 'Web Development' ? 'selected' : '' }}>
                                                    Web Development</option>
                                                <option value="Mobile App Development"
                                                    {{ isset($edit->name) && $edit->name == 'Mobile App Development' ? 'selected' : '' }}>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control" id="validationCustom02"
                                                name="title" placeholder="Jasa DESAIN GRAFIS, Harga Hemat dan Berkualitas Tinggi"
                                        ...
                                        <div class="form-group mb-3">
                                            <label for="validationCustom03" class="form-label">Deskripsi</label>
                                            <textarea class="form-control" id="validationCustom03"
                                                name="description" placeholder="Tingkatkan branding Perusahaan Anda dengan Designer yang tepat / ahlinya. Kami menyediakan jasa..."
                                                required>{{ isset($edit->id) ? $edit->description : '' }}</textarea>
                                                @error('description')
